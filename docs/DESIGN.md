...
|---|---|---|---|---|
| `--cherry` | 피커스 바스켓 체리 | `#a03d36` | `#cd7a6e` | 중요 상태·오답 강조 |
| `--cherry-deep` | 체리 잼 레드 | `#712a28` | `#a75950` | 체리 계열의 깊은 보조 톤 |
| `--green-bean` | 프레시 그린빈 | `#7d8f69` | `#9db184` | 생두 단계·긍정적 진행 상태 |
| `--parchment` | 선베드 파치먼트 | `#e3d4b4` | `#d9c8a6` | 옅은 라이프사이클 배경 |
| `--honey` | 허니 프로세스 골드 | `#c08a3e` | `#d9a95e` | 허니 프로세스·성취 강조 |
